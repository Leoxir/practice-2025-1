...
По решению ответственного за проектную (учебную) практику студентам назначается следующее вариативное задание: "Исследование безопасности протоколов удалённого доступа (RDP)"
